...
export default function EmailChangedEmail({
  userName = "Champion",
  verificationUrl = "https://impulsion.app/verify-email-change",
}: EmailChangedProps) {
  return (
    <EmailLayout>
      <Preview>
      ...
      <BilingualSection lang="fr">
        ...
        >
          Vous avez demande a changer l'adresse email associee a votre compte{" "}
        ...
        >
          Ce lien expire dans 24 heures. Si vous n'avez pas demande ce
          changement, veuillez securiser votre compte immediatement.
        </Text>
